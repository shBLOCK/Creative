...
class Params {
    ...
    offset;
    radius;
    constructor(angle, offset, radius) {
        this.angle = angle;
        this.offset = offset;
        this.radius = radius;
    }
    lerp(other, t) {
        return new Params(this.angle.lerp(other.angle, t), this.offset.lerp(other.offset, t), this.radius.lerp(other.radius, t));
    }
}
...
class Circle {
    ...
    radius;
    isWhite;
    constructor(pos, radius, isWhite) {
        this.pos = pos;
        this.radius = radius;
...
let paramsList = [
    new Params(new WhiteBlackLinear(new Linear(-70, 0), new Linear(-70, 0)), new WhiteBlackLinear(new Linear(-0.5, 10), new Linear(0, 4)), new WhiteBlackLinear(new Linear(50, 20), new Linear(50, 45))),
    new Params(new WhiteBlackLinear(new Linear(-50, 0), new Linear(-50, 0)), new WhiteBlackLinear(new Linear(0, 3), new Linear(0, 4)), new WhiteBlackLinear(new Linear(25, 20), new Linear(25, 24))),
    new Params(new WhiteBlackLinear(new Linear(-50, 0), new Linear(-50, 0)), new WhiteBlackLinear(new Linear(0, 3), new Linear(0, 3)), new WhiteBlackLinear(new Linear(28, 20), new Linear(28, 30))),
    new Params(new WhiteBlackLinear(new Linear(-30, 0), new Linear(-30, 0)), new WhiteBlackLinear(new Linear(0, 23), new Linear(0, 3)), new WhiteBlackLinear(new Linear(30, 50), new Linear(30, 53))),
    new Params(new WhiteBlackLinear(new Linear(-50, 0), new Linear(-50, 0)), new WhiteBlackLinear(new Linear(0, 20), new Linear(0, 10)), new WhiteBlackLinear(new Linear(20, 40), new Linear(20, 35)))
];
function draw() {
    push();
    translate(450, 450);
